...
# Assert
TARGET_OTA_ASSERT_DEVICE := SHV-E120S,SHV-E120,e120s,dali
...
# KERNEL_EXTERNAL_MODULES:$(TARGET_OBJCOPY) device/samsung/e120s/kernel/modules/*.ko $(KERNEL_MODULES_OUT)/
